...
glslangValidator --target-env spirv1.6 -t --client vulkan100 control.comp -o control.comp.spv
...
spirv-opt --skip-validation -O -Os control.comp.spv -o control.comp.spv
