...
namespace ANAMED {
  ...
  public:
    // 
    DenoiserObj(WrapShared<DeviceObj> deviceObj = {}, cpp21::optional_ref<DenoiserCreateInfo> cInfo = DenoiserCreateInfo{}) : PipelineObj(std::move(deviceObj->getHandle())), cInfo(cInfo) {
