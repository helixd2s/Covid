...
namespace ANAMED 
{
  ...
  public: 
    ...
    //
    GltfLoaderObj(Handle const& handle, cpp21::optional_ref<GltfLoaderCreateInfo> cInfo = GltfLoaderCreateInfo{}) : BaseObj(handle), cInfo(cInfo) {
    };
    ...
    //
    inline static tType make(Handle const& handle, cpp21::optional_ref<GltfLoaderCreateInfo> cInfo = GltfLoaderCreateInfo{}) {
