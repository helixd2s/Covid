...
namespace ANAMED {
  ...
  public:
    ...
    // 
    MemoryAllocatorObj(cpp21::optional_ref<Handle> handle, cpp21::optional_ref<MemoryAllocatorCreateInfo> cInfo = MemoryAllocatorCreateInfo{}) : BaseObj(handle), cInfo(cInfo) {
    ...
    //
    inline static tType make(cpp21::optional_ref<Handle> handle, cpp21::optional_ref<MemoryAllocatorCreateInfo> cInfo = MemoryAllocatorCreateInfo{}) {
  ...
  public:
    ...
    //
    virtual std::shared_ptr<AllocatedMemory> allocateMemory(cpp21::optional_ref<MemoryRequirements> requirements, std::shared_ptr<AllocatedMemory> allocated, ExtHandle& extHandle, std::shared_ptr<EXIF> extInfoMap, void*& mapped, std::vector<std::shared_ptr<std::function<DFun>>>& destructors) {
      decltype(auto) deviceObj = ANAMED::context->get<DeviceObj>(this->base);
