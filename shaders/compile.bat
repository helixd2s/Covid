...
glslangValidator --target-env spirv1.6 -t --client vulkan100 overestimate.frag               -o ../prebuild/shaders/overestimate.frag.spv
glslangValidator --target-env spirv1.6 -t --client vulkan100 overestimate.frag -DTRANSLUCENT -o ../prebuild/shaders/overestimate.frag.spv

glslangValidator --target-env spirv1.6 -t --client vulkan100 underestimate.frag               -o ../prebuild/shaders/underestimate.frag.spv
glslangValidator --target-env spirv1.6 -t --client vulkan100 underestimate.frag -DTRANSLUCENT -o ../prebuild/shaders/underestimate.frag.spv
